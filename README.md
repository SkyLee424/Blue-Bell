...
|       | 平均值    | 标准差   | 最大值  | +/- 标准差 |
|-------|---------|---------|---------|------------|
| 延迟  | 120.72ms | 28.11ms | 275.75ms | 85.56%     |
| RPS   |  83.02  | 21.15  |  140.00  | 75.93%     |

- 总请求数：24876
- 测试时长：30.09s
- 请求速率：826.72 次/秒（Requests/sec）
- 吞吐量：5.22MB/sec
...
5. 获取评论列表的压力测试表明，尽管根评论总数为 6k+，但获取前 50 条评论的延迟也在可接受范围内（120.72ms），不过 **仍有提高空间**
